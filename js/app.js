...
function footerRow(total) {
  ...
  let sumBranches = 0;
  for (let i = 0; i < hours.length; i++) {
    totalEachHours.textContent = total;
    sumBranches += total;
  }
  const totalBranches = document.createElement('tf');
